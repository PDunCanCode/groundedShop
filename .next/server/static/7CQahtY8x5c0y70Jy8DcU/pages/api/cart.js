...
/* harmony import */ var _utils_connectDb__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("rn2G");




Object(_utils_connectDb__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])();
const {
  ObjectId
...
const handlePutRequest = async (req, res) => {
  ...
  try {
    ...
    if (productExists) {
      ...
      await _models_Cart__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].findByIdAndUpdate({
        _id: cart._id
      }, {
        $addToSet: {
          products: newProduct
...
const handleDeleteRequest = async (req, res) => {
  ...
  try {
    ...
    const cart = await _models_Cart__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"].findOneAndUpdate({
      user: userId
    }, {
      $pull: {
        products: {
