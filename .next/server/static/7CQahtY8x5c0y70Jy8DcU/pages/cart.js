...
const CartItemList = ({
  ...
  if (products.length === 0) {
    ...
    }), "No products in your cart. Add some!"), __jsx("div", null, user ? __jsx(external_semantic_ui_react_["Button"], {
      color: "violet",
...
const CartSummary = ({
  ...
  const [cartAmout, setCartAmaount] = external_react_default.a.useState(0);
  ...
  return CartSummary_jsx(external_react_default.a.Fragment, null, CartSummary_jsx(external_semantic_ui_react_["Divider"], null), CartSummary_jsx(external_semantic_ui_react_["Segment"], {
    clearing: true,
    size: "large"
  }, CartSummary_jsx("strong", null, "Sub total:"), " $", cartAmout, CartSummary_jsx(external_react_stripe_checkout_default.a, {
    name: "GroundedHLC",
    amount: stripeAmount,
...
const Cart = ({
  ...
  return cart_jsx("div", {
    className: "cart-area"
  }, cart_jsx(external_semantic_ui_react_["Segment"], {
    loading: loading
